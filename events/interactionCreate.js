    ...
    if (interaction.customId == "open-ticket") {
      ...
      interaction.guild.channels.create(`ticket-${interaction.user.username}`, {
        ...
        const embed = new client.discord.MessageEmbed()
          .setColor('6d6ee8')
          .setAuthor({name: `${interaction.user.username}'s Ticket`, iconURL: 'https://media.discordapp.net/attachments/925947526945861653/1061686154560290907/chayduck.jpg'})
        ...
        if (i.customId == 'confirm-close') {
          ...
          chan.edit({
            ...
            .then(async () => {
              const embed = new client.discord.MessageEmbed()
                .setColor('6d6ee8')
                .setAuthor({name: 'Ticket', iconURL: 'https://media.discordapp.net/attachments/925947526945861653/1061686154560290907/chayduck.jpg'})
    ...
    if (interaction.customId == "delete-ticket") {
      ...
      chan.messages.fetch().then(async (messages) => {
        ...
        var result = await paste.uploadContent(a, {uploadFormat: 'markdown'})
            const embed = new client.discord.MessageEmbed()
              .setAuthor({name: 'Ticket Logs', iconURL: 'https://media.discordapp.net/attachments/925947526945861653/1061686154560290907/chayduck.jpg'})
